...
class MyNetModel(ModelInterface):
    ...
    def run_G(self, dict):
        fake_img, move_new_mask = self.G(dict["gray_image"], dict["color_image"], dict["color_flip_image"], dict["gray_one_hot"], dict["color_flip_one_hot"])
        ...
        dict["move_new_mask"] = move_new_mask
        # dict["blended_image"] = blended_image
