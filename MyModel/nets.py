...
class Generator(nn.Module):
    ...
    def set_dict(self):
        ...
        self.base = {
            ...
            "fake":{
                "C_feature": torch.zeros((self.batch_size, 64, self.mid_size ,self.mid_size), device='cuda'), # plz check channel size
                "C_feature_mix": torch.zeros((self.batch_size, 64, self.mid_size ,self.mid_size), device='cuda'), # plz check channel size
                'C_feature_union': torch.zeros((self.batch_size, 64, self.mid_size, self.mid_size), device='cuda'),
                'O_mask': torch.zeros((self.batch_size, 12, self.mid_size, self.mid_size), device='cuda'),
                'B_mask': torch.zeros((self.batch_size, 1, self.mid_size, self.mid_size), device='cuda'),
